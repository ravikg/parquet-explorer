...
describe('DuckDB 1.4.3 API Migration', () => {
    let helper;
    beforeAll(() => {
        helper = new helper_1.DuckDBTestHelper();
    });
    ...
    describe('Connection Initialization', () => {
        test('should create in-memory database successfully', () => {
            ...
            expect(db).toBeInstanceOf(duckdb_1.Database);
            // Clean up
        ...
        test('should execute SQL commands on connection', async () => {
            ...
            const result = await new Promise((resolve, reject) => {
                connection.all('SELECT * FROM test', (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
    ...
    describe('Query Execution', () => {
      ...
      `);
            ...
            const result = await new Promise((resolve, reject) => {
                connection.all('SELECT * FROM users ORDER BY id', (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
      ...
      `);
            const result = await new Promise((resolve, reject) => {
                connection.all('SELECT product, SUM(amount) as total FROM sales GROUP BY product', (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
        ...
        test('should handle query errors gracefully', async () => {
            ...
            await expect(new Promise((resolve, reject) => {
                connection.all('SELECT * FROM nonexistent_table', (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
    ...
    describe('BigInt Serialization', () => {
        test('should handle BigInt values in query results', async () => {
            ...
            await new Promise((resolve, reject) => {
                connection.exec('CREATE TABLE big_data (id INTEGER, value BIGINT)', (err) => {
                    if (err)
                        reject(err);
                    else
                        resolve();
        ...
        `, (err) => {
            ...
            const result = await new Promise((resolve, reject) => {
                connection.all('SELECT * FROM big_data ORDER BY id', (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
        ...
        test('should JSON.stringify results after BigInt conversion', async () => {
            ...
            const result = await new Promise((resolve, reject) => {
                connection.all('SELECT * FROM data', (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
    ...
    describe('Resource Cleanup', () => {
        ...
        test('should handle multiple connections from same database', async () => {
            ...
            const result1 = await new Promise((resolve, reject) => {
                conn1.all('SELECT * FROM test1', (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
            ...
            const result2 = await new Promise((resolve, reject) => {
                conn2.all('SELECT * FROM test2', (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
        ...
        test('should handle connection reuse', async () => {
            ...
            const result1 = await new Promise((resolve, reject) => {
                connection.all('SELECT COUNT(*) as count FROM test', (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
            ...
            const result2 = await new Promise((resolve, reject) => {
                connection.all('SELECT SUM(id) as total FROM test', (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
    ...
    describe('Parquet File Operations', () => {
        ...
        test('should create and read Parquet file', async () => {
            ...
            const result = await new Promise((resolve, reject) => {
                connection.all(`SELECT * FROM read_parquet('${testFilePath}') LIMIT 5`, (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
        ...
        test('should query Parquet file with filters', async () => {
            ...
            const connection = db.connect();
            const result = await new Promise((resolve, reject) => {
                connection.all(`SELECT * FROM read_parquet('${testFilePath}') WHERE int_col > 50 ORDER BY int_col LIMIT 5`, (err, result) => {
                    if (err)
                        reject(err);
                    else
                        resolve(result);
...
//# sourceMappingURL=duckdb.test.js.map